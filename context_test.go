...
func TestGetMidPuffContext(t *testing.T) {
	c := New()
	c.Set("a", 5)
	c.Set("b", 6)
	c.Set("c", 7)
...
func TestFixPuffContext(t *testing.T) {
	c1 := New()
	c1.Set("a", 5)
	c1.Set("b", 6)
	c1.Set("c", 7)
...
func TestDelPuffContext(t *testing.T) {
	c1 := New()
	c1.Set("a", 5)
	c1.Set("b", 6)
	...
	c10.Del("b")
	if c10.Get("b") != 6 {
		t.Error("Error in getting a modified & deleted variable 'b' - 6 != ", c10.Get("b"))
	}
